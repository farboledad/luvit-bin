...
static void cgDeInit(void)
{
    cg_deinit();
}

static u_char *getSNR(void)
{
...
static const u_char *getIntStatus(void)
{
...
static const u_char *decodeServiceType(cg_wwan_system_t t)
{
    if (t & CG_SYS_NONE)
        return "none";
...
static void getNetParameter(cgagent_wwan_req_type_t reqt, netsnmp_request_info *requests)
{
...
static void getSig(cgagent_sig_req_type_t reqt, netsnmp_request_info *requests)
{
...
static const u_char *getRegStatus(int reg)
{
...
static u_char *getPinState(int pin)
{
...
static s_diag getDiagnostics(void)
{
...
static s_cellInfo getLacAndCellId(int opt)
{
...
static void delChar(char *str, char ch)
{
    char *pr = str, *pw = str;
    while (*pr) {
        *pw = *pr++;
...
static unsigned int getClients(int opt)
{
...
static int getWlanChan()
{
    DEBUGMSGTL(("verbose:cloudGatePrivate:getWlanChan", "called\n"));
    uint16_t channel = 0;

    cg_status_t status = cg_wlan_ap_get_channel ("uap0", &channel);
...
static void getTimesAndLoad(char *time, int opt)
{
...
static s_ipConfig getIPConfig(void)
{
...
static void getFirmMode(char *firmware)
{
...
static void getFirmVer(char *firmware)
{
...
static void getCounters(char *dev_name, s_dcounter *counter)
{
...
void init_cloudGatePrivate(void)
{
    ...
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "currentTime", handle_currentTime,
    ...
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "Frequency", handle_wlanFreq,
            wlanFreq_oid, OID_LENGTH(wlanFreq_oid),
            HANDLER_CAN_RONLY
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "Channel", handle_wlanChan,
    ...
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "firmMode", handle_firmMode,
            firmMode_oid, OID_LENGTH(firmMode_oid),
            HANDLER_CAN_RONLY
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "carrier", handle_carrier,
    ...
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "bandClass", handle_bandClass,
            bandClass_oid, OID_LENGTH(bandClass_oid),
            HANDLER_CAN_RONLY
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "serviceType", handle_serviceType,
            serviceType_oid, OID_LENGTH(serviceType_oid),
            HANDLER_CAN_RONLY
        ));
    netsnmp_register_scalar(
        netsnmp_create_handler_registration(
            "rfChannel", handle_rfChannel,
...
int handle_currentTime(netsnmp_mib_handler *handler,
                       netsnmp_handler_registration *reginfo,
                       netsnmp_agent_request_info   *reqinfo,
                       netsnmp_request_info         *requests)
{
...
int handle_sysLoad1(netsnmp_mib_handler *handler,
                    netsnmp_handler_registration *reginfo,
                    netsnmp_agent_request_info   *reqinfo,
                    netsnmp_request_info         *requests)
{
...
int handle_sysLoad5(netsnmp_mib_handler *handler,
                    netsnmp_handler_registration *reginfo,
                    netsnmp_agent_request_info   *reqinfo,
                    netsnmp_request_info         *requests)
{
...
int handle_sysLoad15(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_firmVer(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
...
int handle_AssociatedClients(netsnmp_mib_handler *handler,
                             netsnmp_handler_registration *reginfo,
                             netsnmp_agent_request_info   *reqinfo,
                             netsnmp_request_info         *requests)
{
...
int handle_ClientAssociations(netsnmp_mib_handler *handler,
                              netsnmp_handler_registration *reginfo,
                              netsnmp_agent_request_info   *reqinfo,
                              netsnmp_request_info         *requests)
{
...
int handle_ClientDisassociations(netsnmp_mib_handler *handler,
                                 netsnmp_handler_registration *reginfo,
                                 netsnmp_agent_request_info   *reqinfo,
                                 netsnmp_request_info         *requests)
{
...
int handle_essid(netsnmp_mib_handler *handler,
                 netsnmp_handler_registration *reginfo,
                 netsnmp_agent_request_info   *reqinfo,
                 netsnmp_request_info         *requests)
{
    ...
    switch (reqinfo->mode) {
        case MODE_GET: {
            uint8_t broadcast;
            char *ssid = NULL;
            cg_wlan_ap_get_ssid("uap0", &ssid, &broadcast);

            if (ssid) {
                snmp_set_var_typed_value(requests->requestvb, ASN_OCTET_STR, ssid, strlen(ssid));
                free(ssid);
            } else {
...
int handle_wlanMAC(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
...
int handle_wlanFreq(netsnmp_mib_handler *handler,
                    netsnmp_handler_registration *reginfo,
                    netsnmp_agent_request_info   *reqinfo,
                    netsnmp_request_info         *requests)
{
...
int handle_wlanChan(netsnmp_mib_handler *handler,
                    netsnmp_handler_registration *reginfo,
                    netsnmp_agent_request_info   *reqinfo,
                    netsnmp_request_info         *requests)
{
...
int handle_apn(netsnmp_mib_handler *handler,
               netsnmp_handler_registration *reginfo,
               netsnmp_agent_request_info   *reqinfo,
               netsnmp_request_info         *requests)
{
...
int handle_internetStatus(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info   *reqinfo,
                          netsnmp_request_info         *requests)
{
...
int handle_bCastAddress(netsnmp_mib_handler *handler,
                        netsnmp_handler_registration *reginfo,
                        netsnmp_agent_request_info   *reqinfo,
                        netsnmp_request_info         *requests)
{
...
int handle_netMask(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
...
int handle_csRegistration(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info   *reqinfo,
                          netsnmp_request_info         *requests)
{
...
int handle_psRegistration(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info   *reqinfo,
                          netsnmp_request_info         *requests)
{
...
int handle_imei(netsnmp_mib_handler *handler,
                netsnmp_handler_registration *reginfo,
                netsnmp_agent_request_info   *reqinfo,
                netsnmp_request_info         *requests)
{
...
int handle_imsi(netsnmp_mib_handler *handler,
                netsnmp_handler_registration *reginfo,
                netsnmp_agent_request_info   *reqinfo,
                netsnmp_request_info         *requests)
{
...
int handle_firmMode(netsnmp_mib_handler *handler,
                    netsnmp_handler_registration *reginfo,
                    netsnmp_agent_request_info   *reqinfo,
                    netsnmp_request_info         *requests)
{
...
int handle_carrier(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
...
int handle_rssi(netsnmp_mib_handler *handler,
                netsnmp_handler_registration *reginfo,
                netsnmp_agent_request_info   *reqinfo,
                netsnmp_request_info         *requests)
{
...
int handle_ecio(netsnmp_mib_handler *handler,
                netsnmp_handler_registration *reginfo,
                netsnmp_agent_request_info   *reqinfo,
                netsnmp_request_info         *requests)
{
...
int handle_bandClass(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_serviceType(netsnmp_mib_handler *handler,
                       netsnmp_handler_registration *reginfo,
                       netsnmp_agent_request_info   *reqinfo,
                       netsnmp_request_info         *requests)
{
...
int handle_rfChannel(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_plmn(netsnmp_mib_handler *handler,
                netsnmp_handler_registration *reginfo,
                netsnmp_agent_request_info   *reqinfo,
                netsnmp_request_info         *requests)
{
...
int handle_csCellIDandLac(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info   *reqinfo,
                          netsnmp_request_info         *requests)
{
...
int handle_psCellIDandLac(netsnmp_mib_handler *handler,
                          netsnmp_handler_registration *reginfo,
                          netsnmp_agent_request_info   *reqinfo,
                          netsnmp_request_info         *requests)
{
...
int handle_pinStatus(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_pinRetries(netsnmp_mib_handler *handler,
                      netsnmp_handler_registration *reginfo,
                      netsnmp_agent_request_info   *reqinfo,
                      netsnmp_request_info         *requests)
{
...
int handle_pukRetries(netsnmp_mib_handler *handler,
                      netsnmp_handler_registration *reginfo,
                      netsnmp_agent_request_info   *reqinfo,
                      netsnmp_request_info         *requests)
{
...
int handle_rxPackets(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_rxBytes(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
...
int handle_txPackets(netsnmp_mib_handler *handler,
                     netsnmp_handler_registration *reginfo,
                     netsnmp_agent_request_info   *reqinfo,
                     netsnmp_request_info         *requests)
{
...
int handle_txBytes(netsnmp_mib_handler *handler,
                   netsnmp_handler_registration *reginfo,
                   netsnmp_agent_request_info   *reqinfo,
                   netsnmp_request_info         *requests)
{
